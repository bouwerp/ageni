...
description: Apply feedback from a human reviewer — PR comments, pasted notes, or validating a draft against acceptance criteria before coding. Triggers "address PR feedback", "implement reviewer comments", "apply suggestions", "align with the spec". Distinct from code-review (self-review of your own output).
---
